    ...
    <div className="space-y-8">
      ...
      <Card className="p-6">
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-3">
          <Link
            className="interactive flex items-center justify-between rounded-lg border border-zinc-200 bg-zinc-50/60 p-4 text-sm font-semibold text-zinc-800 hover:border-zinc-300 hover:bg-zinc-100 hover:text-zinc-950"
            to="/quantum-risk"
          >
